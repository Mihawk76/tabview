...
{
    if ($.trim($("#Id_CC1120_New").val()) === "" || $.trim($("#Type_Device_New").val()) === "") {
...
<div id="popupContact">
<!-- Contact Us Form -->
<form action="CC1120_Data_Catch.php" id="form" method="post" name="form">
<img id="close" src="images/3.png" onclick ="div_hide()">
<h2>Contact Us</h2>
<hr>
<table>
	<tr>
		<td style="background-color:white">CC1120 ID</td>
		<td><input size='4' id="Id_CC1120_New" name='Id_CC1120_New' value=''/input></td>
		<td style="background-color:white">CC1120 Label</td>
		<td><input id="Name_CC1120_New" size='20' name='Name_CC1120_New' value=''></td>
	</tr>
	<tr>
		<td style="background-color:white">Device Type</td>
		<td>
			<select id="Type_Device_New" name='Type_Device_New'>
				<option value="" selected='selected'>Select Device Type</option> 
				<option value="IO 442">IO 442</option>
				<option value="KWH">KWH</option>
				<option value="TH">TH</option>
			</select>
		</td>
		<td style="background-color:white">Device Status</td>
		<td>	<select id="Stat_Device_New" name='Stat_Device_New'>
...
<table>
	<tr>
		<td style="background-color:white">Remote CC1120 RSSI</td>
		<td><input size='1' id="RSSI_CC1120_New" name='RSSI_CC1120_New' value=''></td>
		<td>dbm</td>
		<td>&nbsp;</td>
		<td style="background-color:white">Send parameter every</td>
		<td><input size='2' id="Time_Parameter_New" name='Time_Parameter_New' value=''></td>
		<td style="background-color:white">second</td>
	</tr>
	<tr>
		<td><input type="button" value="submit" onClick="check_empty()" /></td>
</tr>
</table>
</form>
</div>
...
//Gettind gata from database for CC1120 
...
?>
	...
	<?php
		echo "<option value='" . $Selected . "'>Selected id " . $Selected . "</option>";
		$Element = 0;
		...
		<tr>
			<td colspan=>
				<center>
					...
					<input type="button" id="popup" onclick="div_show()" name="submit" value='Add New'>
					<input type='submit' name='Delete' onclick="clicked(event)" value='Delete Node'>
				</center>
			</td>
		</tr>
	</table>
